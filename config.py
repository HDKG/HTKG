...
def my_own_opts(parser):
    ...
    parser.add_argument('-n_topic2', type=int, default=15)
    ...
    parser.add_argument('-train_from_checkpoint', default=False, action='store_true')
    parser.add_argument('-check_pt_seq_model_path', type=str)
...
def vocab_opts(parser):
    ...
    parser.add_argument('-vocab_dir', help='path to kp20k vocab.pt')
    # Dictionary Options
