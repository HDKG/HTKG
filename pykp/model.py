...
class Seq2SeqModel(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.posterior_mu = nn.ModuleList(
            [nn.Linear(self.decoder_size, self.decoder_size) for j in range(self.topic_num)])
    ...
    def forward(self, src, src_lens, trg, src_oov, max_num_oov, src_mask, topic_represent, beta, num_trgs=None):
        """
